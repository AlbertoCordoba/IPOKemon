...
namespace IPOkemon
{
       ...
       
    {
        ...
        {
            fmMain.Navigate(typeof(MisPokemon));
            Color_Pestana_Anterior(pestanaAnterior);
            btnMisPokemon.Background = botonPulsado;
            pestanaAnterior = "Mis Pokemon";
        }
        ...
        private void btnAcercaDe_Click(object sender, RoutedEventArgs e)
        {
            ...
            Color_Pestana_Anterior(pestanaAnterior);
            btnAcercaDe.Background = botonPulsado;
