...
namespace IPOkemon
{
    ...
    public sealed partial class AzumarillACR : UserControl,iPokemon
    {
        ...
        public AzumarillACR()
        {
            ...
            Altura = 0.8;
            Peso = 28.5;
            Evolucion = "Es la evolución de Marill";
        ...
        {
            if (!ver) { this.im_corazon.Visibility = Visibility.Collapsed; }
            else { this.im_corazon.Visibility = Visibility.Visible; }
        }
        public void verEscudo(bool ver)
        {
            if (!ver) { this.im_rayo.Visibility = Visibility.Collapsed; }
            else { this.im_rayo.Visibility = Visibility.Visible; }
        }
