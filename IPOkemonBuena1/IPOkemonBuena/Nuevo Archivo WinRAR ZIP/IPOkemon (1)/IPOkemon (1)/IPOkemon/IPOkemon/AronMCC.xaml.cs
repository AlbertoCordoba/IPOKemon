...
namespace IPOkemon
{
    public sealed partial class AronMCC : UserControl, iPokemon1
...

    {
        ...
        Storyboard idle;
        private int danioGolpeCuerpo = 10;
        ...
        {
            if (!ver) { this.txtBNombre.Visibility = Visibility.Collapsed; }
            else { this.txtBNombre.Visibility = Visibility.Visible; }
        }
