...
namespace IPOkemon
{
    public sealed partial class DracofireGDLRS : UserControl, iPokemon
    {
        ...
        {
            ProgressBar_vida.Value -= daño;

        }
        public void disminuirEnergia(object sender, object e)
        {
            this.ProgressBar_escudo.Value -= 10;
        ...
        {
            if (!ver) { this.Vidaa.Visibility = Visibility.Collapsed; }
            else { this.Vidaa.Visibility = Visibility.Visible; }
        }
