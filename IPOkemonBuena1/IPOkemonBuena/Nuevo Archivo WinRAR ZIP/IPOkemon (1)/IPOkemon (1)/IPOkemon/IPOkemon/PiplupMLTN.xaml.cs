...
namespace IPOkemon
{
    public sealed partial class PiplupMLTN : UserControl, iPokemon
    {
        ...
        public void verFilaEnergia(bool verFilaEnergia)
        {
            if (!verFilaEnergia)
            {
                this.barra_ataque.Visibility = Visibility.Collapsed;
            }
            else
                this.barra_ataque.Visibility = Visibility.Visible;
        }

        public void verCorazon(bool ver)
        {
            {
                if (!ver) { this.simbolo_vida.Visibility = Visibility.Collapsed; }
                else { this.simbolo_vida.Visibility = Visibility.Visible; }
            }
        }
        public void verEscudo(bool ver)
        {
            {
                if (!ver) { this.simbolo_energia.Visibility = Visibility.Collapsed; }
                else { this.simbolo_energia.Visibility = Visibility.Visible; }
            }
        }
