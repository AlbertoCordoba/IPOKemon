...
namespace IPOkemon
{
    public sealed partial class MakuhitaAPQ2 : UserControl, iPokemon
    {
        ...
        {
            if (!ver) { this.imagenVida.Visibility = Visibility.Collapsed; }
            else { this.imagenVida.Visibility = Visibility.Visible; }
        }
        public void verEscudo(bool ver)
        {
            if (!ver) { this.imagenEnergia.Visibility = Visibility.Collapsed; }
            else { this.imagenEnergia.Visibility = Visibility.Visible; }
        }
