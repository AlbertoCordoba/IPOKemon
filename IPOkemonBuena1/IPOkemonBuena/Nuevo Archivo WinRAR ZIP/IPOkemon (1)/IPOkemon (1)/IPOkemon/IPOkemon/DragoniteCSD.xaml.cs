...
namespace IPOkemon
{
    public sealed partial class DragoniteCSD : UserControl, iPokemon3
    {
        public DragoniteCSD()
        {
        ...
        public string Categoria { get { return "Dragon"; } set { } }
        ...
        {
            if (!ver) { this.Img_Vida.Visibility = Visibility.Collapsed; }
            else { this.Img_Vida.Visibility = Visibility.Visible; }
        }
        public void verEscudo(bool ver)
        {
            if (!ver) { this.Img_Stamina.Visibility = Visibility.Collapsed; }
            else { this.Img_Stamina.Visibility = Visibility.Visible; }
        }
