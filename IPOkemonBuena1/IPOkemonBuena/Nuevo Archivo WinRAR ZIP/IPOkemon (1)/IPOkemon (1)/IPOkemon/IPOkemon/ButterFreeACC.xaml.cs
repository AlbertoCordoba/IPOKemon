...
namespace IPOkemon
{
    public sealed partial class ButterFreeACC : UserControl, iPokemon
    {
        ...
        private string tipo = "bicho/volador";
        ...
        public double Vida { get { return barra_vida.Value; } set { barra_vida.Value = value; }  }
        ...
        {
            this.barra_vida.Value -= daño;

        }
        public void disminuirEnergia(object sender, object e)
        {
            this.barra_energia.Value -= 10;
        ...
        public void verFondo(bool ver)
        {
            ...
            else
            {
                ...
                this.imFondo.Source = new BitmapImage(new Uri("ms-appx:///AssetsButterFreeACC/fondo1.jpg"));
            }
        }
        ...
        public void verFilaVida(bool ver)
        {
            if (!ver) { this.barra_vida.Visibility = Visibility.Collapsed; }
            else { this.barra_vida.Visibility = Visibility.Visible; }
        }
