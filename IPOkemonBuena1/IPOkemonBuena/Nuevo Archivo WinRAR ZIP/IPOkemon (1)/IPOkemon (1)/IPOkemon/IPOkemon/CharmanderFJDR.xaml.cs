...
namespace IPOkemon
{
	...
	public sealed partial class CharmanderFJDR : UserControl, iPokemon2

	{
        ...
        public void verPocionVida(bool verPocionVida)
        {
            if (!verPocionVida)
            {
                this.imgPocionVida.Visibility = Visibility.Collapsed;
            }
            else
                this.imgPocionVida.Visibility = Visibility.Visible;
        }
        ...
        public void verPocionEnergia(bool verPocionEnergia)
        {
            if (!verPocionEnergia)
            {
                this.imgPocionEnergia.Visibility = Visibility.Collapsed;
            }
            else
                this.imgPocionEnergia.Visibility = Visibility.Visible;
        }
